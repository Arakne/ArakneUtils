...
class RandomUtilTest {
    ...
    void integerPredictable() {
        assertEquals(60, util.nextInt(100));
        assertEquals(48, util.nextInt(100));
        assertEquals(29, util.nextInt(100));
        assertEquals(47, util.nextInt(100));
    }
    ...
    void createSharedShouldBeResetWhenEnableTestingMode() {
        ...
        assertEquals(0, r1.nextInt(10));
        assertEquals(8, r1.nextInt(10));
        assertEquals(0, r2.nextInt(10));
        assertEquals(8, r2.nextInt(10));
